-- Migration: Create billing_periods table
-- Description: Billing periods define time ranges for fee calculations and billing cycles
-- Supports both standard (recurring) and custom (one-time) billing periods
